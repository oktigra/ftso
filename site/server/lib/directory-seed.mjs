...
export const DIRECTORY_SEED = {
  courts: [
    ...
    { name: 'Спортивный клуб «Купол»', city: 'Смоленск', address: 'ул. Попова, 31', surface: 'хард', courts_count: '', season: 'круглый год (под куполом)', club: 'СК «Купол»', contact: '+7 (919) 041-07-77, +7 (4812) 68-66-08', map_url: 'https://yandex.ru/maps/?text=Смоленск, ул. Попова, 31', note: 'Крытый корт под куполом, тренер, раздевалки, душ. Ежедневно 8:00–22:00. Здесь же — юридический адрес Федерации. Число кортов — уточнить.' },
    ...
    { name: 'Спортивный комплекс ЦСКА (филиал ФАУ МО РФ ЦСКА)', city: 'Смоленск', address: 'ул. Багратиона, 25', surface: '', courts_count: '', season: 'лето (открытые)', club: 'ЦСКА, Смоленск', contact: '+7 (4812) 65-37-50', map_url: 'https://yandex.ru/maps/?text=Смоленск, ул. Багратиона, 25', note: 'Открытые теннисные корты на территории комплекса (стадион, бассейн, гостиница). Покрытие и число кортов — уточнить у администрации.' },
    { name: 'Спортивный комплекс «МЖК»', city: 'Сафоново', address: 'микрорайон МЖК, 2а', surface: '', courts_count: '1', season: 'круглый год (в зале)', club: '', contact: '', map_url: 'https://yandex.ru/maps/?text=Сафоново, микрорайон МЖК, 2а', note: 'По отзывам — большой теннисный корт в зале спорткомплекса, есть и настольный теннис. Телефон и покрытие — уточнить.' },
  ],
  clubs: [

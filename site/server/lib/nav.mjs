...
// «Заявка на турнир» вела на «#», пока формы не существовало. С появлением
// /tournament-request (заявка организатора на проведение турнира) пункт ведёт
// туда: маршрут живой, на него же указывает кнопка «Провести турнир» с главной.

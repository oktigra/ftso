...
export const SITE_TEXTS = [
  ...
  { key: 'home-photo-caption', label: 'Главная — подпись к фото первого экрана (пусто — подписи нет)', max: 120, multiline: false,
    fallback: '' },
  ...
  { key: 'partners-title', label: 'Партнёры — подпись слева от логотипов', max: 60, multiline: false,
    fallback: 'Партнёры Федерации' },
  { key: 'partners-cta', label: 'Партнёры — приглашение в свободном слоте', max: 200, multiline: false,
    fallback: 'Станьте партнёром или спонсором — и ваша реклама будет здесь' },
